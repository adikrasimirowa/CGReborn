   ...
   <div class="panel panel-primary">
    <div class="panel-heading">Добави нова категория :</div>
     <div class="panel-body">
      ...
      ?>
      <label>Профил :</label><?php echo form_input(array( 'class'=>'form-control','name' => 'profile_short')); ?>
      <label>Описание :</label><?php echo form_input(array( 'class'=>'form-control','name' => 'profile')); ?>
