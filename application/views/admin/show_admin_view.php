                                    ...
                                    <tbody>
                                        ...
                                        if (isset($all_admins)) {
                                            ...
                                            foreach ($all_admins as $key => $value) {
                                                ...
                                                <td>'.$value['email'].'</td>
                                                <td><a href="'.base_url().'index.php/user/update_admin/'.$value['user_id'].'"><button class="btn btn-warning">Редактирай</button></a></td>
                                                <td><button class="btn btn-danger" data-href="'.base_url().'index.php/user/delete_admin/'.$value['user_id'].'" data-toggle="modal" data-target="#confirm-delete">Изтрий</button></td>
                                                </tr>';
                                                $br++;
                                            }
                                        }
